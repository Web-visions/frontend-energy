...
const LeadFormModal = ({ isOpen, onClose, projectType }) => {
    ...
    const validateForm = () => {
        ...
        const currentFields = currentProject.fields;
    ...
    const renderField = (fieldName) => {
        const fieldConfig = {
            ...
            loadInKW: {
                label: 'Load in KW *',
                type: 'number',
                placeholder: 'Enter your load requirement in KW',
                icon: FiZap
            },
            backupTime: {
                label: 'Backup Time *',
            ...
            rooftopSpace: {
                label: 'Rooftop Space *',
                type: 'text',
                placeholder: 'e.g., 1000 sq ft, 500 sq ft',
                icon: FiHome
            },
            sanctionLoad: {
                label: 'Sanction Load by Govt. *',
                type: 'text',
            ...
            investmentAmount: {
                ...
                type: 'text',
                placeholder: 'e.g., 2-3 lakhs, 5-7 lakhs',
                icon: FiDollarSign
            }
        };
            ...
            <div className="bg-white rounded-2xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-[#008246] text-white font-semibold py-3 px-6 rounded-lg hover:bg-[#005a2f] transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
