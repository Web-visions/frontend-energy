...
const Footer = () => {
  ...
  return (
    <footer ref={footerRef} className="bg-[#008246] text-white py-12 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="footer-section">
          ...
          <div className="flex space-x-4 text-white text-lg">
            <a href="#" className="hover:text-[#E4C73F] transition-colors">
        ...
        <div className="footer-section">
          ...
          <ul className="space-y-2 text-sm text-gray-200">
            ...
            <li><a href="#" className="hover:text-[#E4C73F] transition-colors">About Us</a></li>
            <li><a href="#" className="hover:text-[#E4C73F] transition-colors">Products</a></li>
        ...
        <div className="footer-section">
          ...
          <ul className="space-y-2 text-sm text-gray-200">
            <li><a href="#" className="hover:text-[#E4C73F] transition-colors">Inverters</a></li>
            <li><a href="#" className="hover:text-[#E4C73F] transition-colors">UPS Systems</a></li>
            <li><a href="#" className="hover:text-[#E4C73F] transition-colors">Batteries</a></li>
            <li><a href="#" className="hover:text-[#E4C73F] transition-colors">Solar Panels</a></li>
            <li><a href="#" className="hover:text-[#E4C73F] transition-colors">Stabilizers</a></li>
            <li><a href="#" className="hover:text-[#E4C73F] transition-colors">Battery Water</a></li>
            <li><a href="#" className="hover:text-[#E4C73F] transition-colors">Accessories</a></li>
          </ul>
        </div>
